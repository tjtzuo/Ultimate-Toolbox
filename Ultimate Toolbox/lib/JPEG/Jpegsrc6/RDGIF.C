...
typedef struct {
  ...
  jpeg_boolean out_of_blocks;	/* TRUE if hit terminator data block */
  ...
  jpeg_boolean first_time;		/* flags first call to LZWReadByte */
  ...
  jpeg_boolean is_interlaced;	/* TRUE if have interlaced image */
