...
NewFileInclude2=#include "tabviews.h"
LastPage=0
...
Class2=CHexView
Class3=CMainFrame
Class4=CStatisticsView
Class5=CTabViewsApp
Class6=CTabViewsDoc
Class7=CTabViewsView

ResourceCount=5
Resource1=IDR_MAINFRAME (English (U.S.))
Resource2=IDR_TABVIETYPE (English (U.S.))
Resource3=IDR_TABVIETYPE
...
Type=0
BaseClass=CWinApp
HeaderFile=TabViews.h
ImplementationFile=TabViews.cpp

[CLS:CTabViewsDoc]
Type=0
BaseClass=CDocument
HeaderFile=TabViewsDoc.h
ImplementationFile=TabViewsDoc.cpp

[CLS:CTabViewsView]
Type=0
BaseClass=CEditView
HeaderFile=TabViewsView.h
ImplementationFile=TabViewsView.cpp
...
[MNU:IDR_TABVIETYPE (English (U.S.))]
Type=1
Class=?
Command1=ID_FILE_NEW
Command2=ID_FILE_OPEN
...
[CLS:CStatisticsView]
Type=0
HeaderFile=StatisticsView.h
ImplementationFile=StatisticsView.cpp
BaseClass=CListView
Filter=C
LastObject=CStatisticsView
VirtualFilter=VWC
